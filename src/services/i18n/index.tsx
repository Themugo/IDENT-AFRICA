 ...
 */
export function formatNumber(num: number, language: Language = 'en', options?: Intl.NumberFormatOptions): string {
 ...
 */
export function formatCurrency(amount: number, language: Language = 'en', currency = 'USD'): string {
