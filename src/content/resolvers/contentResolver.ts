...
let databaseCache: Map<string, ContentItem<unknown>[]> = new Map();
...
export function resolveDestinations(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_DESTINATIONS[number]>[] = [];
...
export function resolveHotels(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_HOTELS[number]>[] = [];
...
export function resolvePackages(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_PACKAGES[number]>[] = [];
...
export function resolveExperiences(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_EXPERIENCES[number]>[] = [];
...
export function resolveTestimonials(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_TESTIMONIALS[number]>[] = [];
...
export function resolveAddons(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_ADDONS[number]>[] = [];
...
export function resolvePartners(options?: {
  ...
  let items: ContentItem<typeof DEFAULT_PARTNERS[number]>[] = [];
