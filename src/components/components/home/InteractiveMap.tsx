...
export const InteractiveMap: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8 bg-[#E8DCC8] text-[#2A1E17] border-y border-[#C89A4B]/40 texture-map">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            {hotspots.map((spot) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Tooltip Label */}
                  <div className="mt-1 px-2 py-0.5 rounded bg-[#FFF8EC] text-[11px] font-mono font-bold text-[#2A1E17] border border-[#C89A4B]/50 shadow-md opacity-90 group-hover:opacity-100 whitespace-nowrap">
                    {spot.name}
                  </div>
                </button>
              );
          ...
          <div className="lg:col-span-5 bg-[#FFF8EC] border-2 border-[#C89A4B]/60 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl card-journal">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#5A4738] mt-3 leading-relaxed font-normal">
