...
export const VisualItineraryBuilder: React.FC = () => {
  ...
  // Sync when activeBuilderItinerary changes externally (intentionally keyed
  // on id only, not the whole object — re-syncing on every field mutation
  // would wipe out in-progress local edits made in this builder)
  React.useEffect(() => {
