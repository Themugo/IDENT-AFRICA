...
import { ShieldCheck, Award, Trees, DollarSign, MapPin, Globe } from 'lucide-react';
...
export const TrustPillars: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8 bg-[#E8DCC8] border-b border-[#C89A4B]/40 relative overflow-hidden texture-savannah">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <span className="text-[11px] font-mono font-bold text-[#4F6848] uppercase tracking-[0.3em]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((p, i) => (
            ...
            >
              ...
              <div>
                <span className="text-[11px] uppercase tracking-widest font-bold text-[#4F6848] block font-mono">
                  {p.subtitle}
                </span>
              ...
              <p className="text-[13px] text-[#5A4738] leading-relaxed font-normal">
                {p.description}
              </p>
            </div>
          ))}
