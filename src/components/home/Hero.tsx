        ...
        <div className="w-full lg:w-7/12 p-5 sm:p-8 lg:p-10 flex flex-col justify-between border-r border-[#C89A4B]/30 space-y-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#2D2621]/80 border border-[#C89A4B]/60 rounded-full mb-4 backdrop-blur-sm shadow-sm">
              ...
              <span className="text-[9.5px] font-bold uppercase tracking-[0.25em] text-[#D6B06A] font-mono">
                East Africa • Serengeti & Masai Mara
              </span>
            </div>

            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-serif leading-[0.9] tracking-tight mb-4 text-[#F4E8D5]">
              The Great <br />
            ...
            <p className="max-w-lg text-sm sm:text-base leading-relaxed text-[#D3C5AE] font-medium">
              ...
              <div className="flex-1 p-6 sm:p-7 relative overflow-hidden min-h-[140px] flex flex-col justify-center">
                ...
                <div className="relative z-10 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#4F6848] font-mono block">
                    ...
                    <div className="flex items-center gap-1 bg-[#E8DCC8]/90 p-1 rounded-lg border border-[#C89A4B]/40">
                      ...
                      <span className="text-[9px] font-mono text-[#2A1E17] px-1 font-bold">
        ...
        <div className="w-full lg:w-5/12 flex flex-col justify-center p-4 sm:p-6 lg:p-8 border-t lg:border-t-0 border-[#C89A4B]/30 relative">
          ...
          <div className="bg-[#FFF8EC]/85 backdrop-blur-md rounded-2xl p-5 sm:p-6 space-y-4 shadow-2xl border border-[#C89A4B]/80 text-[#2A1E17] relative overflow-hidden texture-parchment">
            ...
            <div className="flex items-center justify-between border-b border-[#C89A4B]/30 pb-4">
              ...
              <span className="text-[10px] bg-[#4F6848] text-[#FFF8EC] px-2.5 py-1 font-bold uppercase tracking-wider rounded border border-[#C89A4B]">
                Ranger Verified
              </span>
            </div>
            ...
            <form onSubmit={handleSearchSubmit} className="space-y-3">
              ...
              <div className="space-y-1">
                <label className="text-[9.5px] font-bold uppercase tracking-widest text-[#4F6848] block font-mono">
                  Sanctuary / Country
                </label>
                <select
            ...
            <div className="pt-3 border-t border-[#C89A4B]/30 grid grid-cols-2 gap-3">
              <div>
                <p className="text-[9px] uppercase font-bold text-[#5A4738] tracking-widest font-mono">
                  Eco-Rating Average
                </p>
              ...
              <div>
                ...
                <p className="text-[10px] text-[#4F6848] font-bold flex items-center gap-1 mt-0.5">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center gap-8 py-6 opacity-60 text-[10px] font-mono text-[#4F6848] tracking-widest font-bold">
