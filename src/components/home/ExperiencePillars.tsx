...
import { Compass, ArrowRight, Footprints, HeartHandshake, Utensils, Anchor, Mountain, Building2, Landmark } from 'lucide-react';
...
export const ExperiencePillars: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8 bg-[#463D34] text-[#F4E8D5] relative overflow-hidden texture-map border-b border-[#C89A4B]/40">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1 bg-[#2D2621] border border-[#C89A4B]/60 rounded-full shadow-md">
            ...
            <span className="text-[11px] font-mono font-bold uppercase tracking-[0.25em] text-[#D6B06A]">
          ...
          {pillars.map((pillar, idx) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-[#2D2621]">
                ...
                <div className="absolute top-3 left-3 px-2.5 py-1 bg-[#2D2621]/90 text-[#D6B06A] text-[11px] font-mono font-bold uppercase tracking-widest border border-[#C89A4B]/80 rounded shadow-md">
                  {pillar.category}
                </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  ...
                  <p className="text-[11px] font-mono font-bold uppercase tracking-widest text-[#C89A4B] mt-1">
                    {pillar.subtitle}
                  </p>
                  <p className="text-[13px] text-[#5A4738] mt-2.5 line-clamp-2 leading-relaxed">
                    {pillar.description}
                  </p>
                </div>

                <div className="pt-3 border-t border-[#C89A4B]/30 flex items-center justify-between">
                  <span className="text-[11px] font-mono font-bold uppercase text-[#4F6848] bg-[#F5E7D0] px-2 py-0.5 rounded border border-[#C89A4B]/30">
                    {pillar.stat}
                  </span>
