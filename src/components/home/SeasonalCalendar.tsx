...
export const SeasonalCalendar: React.FC = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#463D34] text-[#F4E8D5] relative border-b border-[#C89A4B]/40 texture-leather overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 border-b border-[#C89A4B]/30 pb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#2D2621] border border-[#C89A4B]/60 text-[#D6B06A] text-[10px] font-mono font-bold uppercase tracking-[0.25em] mb-3 shadow-md">
          ...
          <div className="grid grid-cols-6 sm:grid-cols-12 gap-1.5 sm:gap-2 p-2 bg-[#1A1008]/90 rounded-2xl border-2 border-[#C89A4B]/60 shadow-2xl overflow-x-auto">
            {MONTHS.map((m) => {
              ...
              return (
                ...
                >
                  <span className="text-[10px] font-mono uppercase tracking-wider opacity-80">{m.short}</span>
            ...
            {filteredEvents.map((event) => (
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden bg-[#2E2015]">
                  ...
                  {/* Category Pill */}
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#1A1008]/90 text-[#D6B06A] text-[10px] font-mono font-bold uppercase tracking-widest border border-[#C89A4B] rounded-md shadow-md z-10">
                    {event.category}
                  </div>

                  {/* Country Badge */}
                  <div className="absolute top-4 right-4 px-2.5 py-1 bg-[#FFF8EC]/90 text-[#2A1E17] text-[10px] font-mono font-extrabold uppercase tracking-wider rounded-md border border-[#C89A4B]/50 z-10 shadow">
                    {event.country}
                  </div>

                  {/* Region & Peak Season */}
                  <div className="absolute bottom-3 left-4 right-4 z-10 text-white">
                    <span className="text-[10px] font-mono font-bold text-[#D6B06A] uppercase tracking-wider block">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-[#5A4738] leading-relaxed line-clamp-3">
                      {event.summary}
                    </p>
                  </div>
                  ...
                  <div>
                    <span className="text-[9px] font-mono uppercase font-bold text-[#5A4738] block mb-1.5">
                      Key Sightings & Focus:
                    </span>
                    <div className="flex flex-wrap gap-1.5">
                      {event.keyAnimals.map((animal) => (
                        <span
                          key={animal}
                          className="px-2 py-0.5 text-[9px] font-mono font-bold bg-[#F5E7D0] text-[#2A1E17] border border-[#C89A4B]/40 rounded-md"
                        >
                          {animal}
                        </span>
                      ))}
                  ...
                  <div className="pt-3 border-t border-[#C89A4B]/30 flex items-center justify-between text-xs font-mono">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1 text-[10px] font-bold text-[#2A1E17] bg-[#E8DCC8] px-2 py-0.5 rounded border border-[#C89A4B]/30">
