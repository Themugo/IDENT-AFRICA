...
import { Country, WildlifeFocus, LuxuryTier } from '../../types';
import {
  Sparkles, Calendar, Users, Building2, Compass, 
  Phone, Mail, ChevronRight, ChevronLeft, CheckCircle, Star, Sun, Moon, Mountain, TreePine, Palmtree, Camera,
  Download, Printer, Loader2, Shield, Heart, PawPrint, Leaf
} from 'lucide-react';
