...
async function startServer() {
  ...
  app.use('/api/loyalty', optionalAuth, loyaltyRouter);
  app.use('/api/quality', optionalAuth, qualityRouter);
  app.use('/api/sustainability', optionalAuth, sustainabilityRouter);
  app.use('/api/automation', optionalAuth, automationRouter);
  app.use('/api/monetization', optionalAuth, monetizationRouter);
