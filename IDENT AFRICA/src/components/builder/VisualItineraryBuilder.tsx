    ...
    <div className="min-h-screen bg-[#2E2015] text-[#F4E8D5] pb-24 texture-earth">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#C89A4B] hover:bg-[#D6B06A] text-[#2E2015] rounded-xl text-xs font-mono font-black transition-all flex items-center gap-1.5 shadow-md"
      ...
      {pdfPreviewOpen && (
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#FAF7F2] text-[#2E2015] rounded-2xl max-w-3xl w-full p-8 space-y-6 shadow-2xl relative my-8 print:p-0 print:m-0 print:shadow-none print:max-w-none">
            
            {/* Action Bar (Hidden in Print) */}
            <div className="flex items-center justify-between border-b border-[#2E2015]/20 pb-4 print:hidden">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-1 bg-[#2E2015] text-[#D6B06A] text-[10px] font-mono font-bold uppercase rounded">
                  PDF Dossier Generator
                </span>
                <span className="text-xs font-mono text-[#2E2015]/70">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-[#C89A4B] text-[#2E2015] font-bold rounded-xl text-xs flex items-center gap-1.5 hover:bg-[#D6B06A] transition-all shadow-md"
                >
            ...
            <div className="space-y-6">
              ...
              {/* Title & Overview */}
              <div className="bg-[#F0EAE1] p-4 rounded-xl border border-[#C89A4B]/30 space-y-2">
                <h2 className="text-2xl font-serif font-bold text-[#2E2015]">
                  {currentItin.title}
                </h2>
                ...
                <div className="grid grid-cols-4 gap-2 pt-2 border-t border-[#C89A4B]/20 text-[11px] font-mono">
                  <div>
                    <span className="text-[9px] uppercase text-[#2E2015]/60 block">Duration</span>
                    <span className="font-bold">{calculationSummary.totalDays} Days / {calculationSummary.totalDays - 1} Nights</span>
                  </div>
                  <div>
                    <span className="text-[9px] uppercase text-[#2E2015]/60 block">Guests</span>
                    <span className="font-bold">{calculationSummary.travelersCount} Travelers</span>
                  </div>
                  <div>
                    <span className="text-[9px] uppercase text-[#2E2015]/60 block">Distance</span>
                    <span className="font-bold">{calculationSummary.totalDistanceKm} km Transit</span>
                  </div>
                  <div>
                    <span className="text-[9px] uppercase text-[#2E2015]/60 block">Total Est. Cost</span>
              ...
              <div className="space-y-4">
                ...
                {Array.from({ length: calculationSummary.totalDays }, (_, i) => i + 1).map((dayNum) => {
                  ...
                  return (
                    <div key={dayNum} className="border border-[#2E2015]/20 rounded-xl p-4 space-y-2">
                      <div className="flex items-center justify-between border-b border-[#2E2015]/10 pb-2">
                        ...
                        <span className="text-[10px] font-mono text-[#2E2015]/60">
                          {dayItems.length} Modules
                        </span>
                      </div>

                      {dayItems.length === 0 ? (
                        <p className="text-xs text-[#2E2015]/50 italic">Leisure / Free Schedule</p>
                      ) : (
                        <div className="space-y-2">
                          {dayItems.map((item) => (
                            <div key={item.id} className="flex items-start justify-between text-xs pt-1">
                              <div>
                                <span className="font-mono font-bold uppercase text-[10px] text-[#C89A4B] mr-2">
                                  [{item.type}]
                                </span>
                                <span className="font-bold text-[#2E2015]">{item.title}</span>
                                {item.notes && (
                                  <p className="text-[11px] text-[#2E2015]/70 italic mt-0.5">
                                    Note: {item.notes}
                                  </p>
                                )}
                              </div>
                              <span className="font-mono font-bold text-[#2E2015]">
                                {formatPrice(item.costUSD)}
                              </span>
                            </div>
                          ))}
              ...
              {/* Conservation Footer Note */}
              <div className="border-t border-[#C89A4B]/40 pt-4 text-center space-y-1 text-[10px] font-mono text-[#2E2015]/70">
                <p className="font-bold">Ident Africa Conservation Trust • Official Ranger Certification</p>
                <p>100% of conservation entry fees directly fund antipoosting rangers and community wildlife conservancies.</p>
              </div>
